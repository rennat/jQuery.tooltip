...
- Called initially and when the window is resized. 'this' represents the element given tooltip. Receives the arguments event, the javascript event; container, which is the generated tooltip container.

show, hide
~~~~~~~~~~
- Function(event, container, callback)
- Called when the tooltipped element hover starts and stops. 'this' represents the element given tooltip. Receives the arguments event, the javascript event; container, which is the generated tooltip container; and callback, which should be used as the animation complete function so that onShow and onHide are called.
